{inputs, ...}: {
  perSystem = {
    ...
    packages = {
      default = packages.uci-builder;
      uci-builder = craneLib.buildPackage ({
          pname = "uci-builder";
          cargoArtifacts = deps-only;
          cargoExtraArgs = "--bin uci-builder";
          meta.mainProgram = "uci-builder";
        }
        // common-build-args);
  ...
  in rec {
    ...
    apps = {
      uci-builder = {
        type = "app";
        program = pkgs.lib.getBin self'.packages.uci-builder;
      };
      default = apps.uci-builder;
    };
